	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 m_corr text_center">
				...
				<br>
				<form method="post" action="<c:url value="<%=AppConstant.USER_REGISTRATION_CONT%>"/> ">
					...
					<input type="password" class="form-control" name="<%=AppConstant.PASSWORD_VERIFICATION_PARAMETER%>" placeholder="Введите подтверждение пароля"><br>
